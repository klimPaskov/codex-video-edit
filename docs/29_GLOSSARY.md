...
- **Project source:** Imported or recorded original media that is never overwritten.
- **Revision:** Immutable snapshot of a draft and its dependencies.
- **Scene:** Planned recording unit with script and one or more takes.
