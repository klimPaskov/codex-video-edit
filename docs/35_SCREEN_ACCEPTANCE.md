...
- Codex remains available with managed ChatGPT sign-in; implemented OpenAI API, DeepSeek and Gemini API rows show separate key and billing states with no exposed key bytes.
