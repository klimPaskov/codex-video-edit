...
| Pinned real stdio and thread runtime | 08; codex-protocol contract; P2 runtime policy research; codex_thread_view schema/example | P2-01, P2-03, P2-04, P2-07 (partial) | 205-type experimental generated closure; transport/client/thread/stream/registry/view tests cover exact requests, create/resume, ordered streaming, interrupt, idle unsubscribe, retry and redaction; isolated packaged signed-out startup verifies owned MCP names and input schemas; authenticated/edit gates remain required |
