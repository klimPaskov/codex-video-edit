...
Settings persists 100%, 125%, 150%, or 200% interface size through main-owned validated storage. Ctrl+, opens its modal; Escape or Cancel discards unsaved choices and returns focus. Source details and the Codex drawer are mutually exclusive beside the preview. The five-stage project shell and signed-out Codex foundation have passed their scoped packaged native checks; authenticated turns and the later editor remain incomplete.
